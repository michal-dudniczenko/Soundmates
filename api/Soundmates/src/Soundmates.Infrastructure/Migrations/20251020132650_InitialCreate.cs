        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    IsForBand = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Artists_Genders_GenderId",
                        column: x => x.GenderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dislikes_Users_GiverId",
                        column: x => x.GiverId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Dislikes_Users_ReceiverId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusicSamples", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MusicSamples_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "UserMatchPreferences",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ShowArtists = table.Column<bool>(type: "boolean", nullable: false),
                    ShowBands = table.Column<bool>(type: "boolean", nullable: false),
                    MaxDistance = table.Column<int>(type: "integer", nullable: true),
                    CountryId = table.Column<Guid>(type: "uuid", nullable: true),
                    CityId = table.Column<Guid>(type: "uuid", nullable: true),
                    ArtistMinAge = table.Column<int>(type: "integer", nullable: true),
                    ArtistMaxAge = table.Column<int>(type: "integer", nullable: true),
                    ArtistGenderId = table.Column<Guid>(type: "uuid", nullable: true),
                    BandMinMembersCount = table.Column<int>(type: "integer", nullable: true),
                    BandMaxMembersCount = table.Column<int>(type: "integer", nullable: true),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMatchPreferences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserMatchPreferences_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BandRoleId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "TagUserMatchPreference",
                columns: table => new
                {
                    TagsId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserMatchPreferenceId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagUserMatchPreference", x => new { x.TagsId, x.UserMatchPreferenceId });
                    table.ForeignKey(
                        name: "FK_TagUserMatchPreference_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagUserMatchPreference_UserMatchPreferences_UserMatchPrefer~",
                        column: x => x.UserMatchPreferenceId,
                        principalTable: "UserMatchPreferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagUserMatchPreference_UserMatchPreferenceId",
                table: "TagUserMatchPreference",
                column: "UserMatchPreferenceId");

            migrationBuilder.CreateIndex(
                name: "IX_UserMatchPreferences_UserId",
                table: "UserMatchPreferences",
                column: "UserId",
                unique: true);
